...
const String solicitudestrabajador = 'https://mondongodb-lara.aclx8p.easypanel.host/solicitudes-por-trabajador'; 
...
Future<List<Post>> getSolicitudesTrab(String id) async {
  final response = await http.get(
    Uri.parse('$solicitudestrabajador/$id'),
    headers: {"Content-Type": "application/json"},
  );
